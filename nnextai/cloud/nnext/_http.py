...
"""Create / interact with NNext connections."""

import os

from nnextai.cloud.nnext import _http  # type: ignore  # pytype: disable=import-error
from nnextai.cloud.nnext import __version__


class Connection(_http.JSONConnection):
    """A connection to NNext via the JSON REST API.
    ...
    DEFAULT_API_ENDPOINT = "https://api.nnext.io"
    DEFAULT_API_MTLS_ENDPOINT = "https://api.mtls.nnext.io"
    ...
    API_URL_TEMPLATE = "{api_base_url}/{api_version}/nn/{path}"  # type: ignore
