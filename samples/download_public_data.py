...
def download_public_data() -> None:
    # [START nnext_pandas_public_data]
    ...
    table_id = "nnext-public-data.usa_names.usa_1910_current"

    # Use the NNext Storage API to speed-up downloads of large tables.
    dataframe = nnclient.list_rows(table_id).to_dataframe(create_bqstorage_client=True)

    print(dataframe.info())
    # [END nnext_pandas_public_data]
