...
def load_table_uri_truncate_parquet(table_id: str) -> None:
    # [START nnext_load_table_gcs_parquet_truncate]
    import io
    ...
    job_config = nnext.LoadJobConfig(
        ...
        source_format=nnext.SourceFormat.PARQUET,
    )

    uri = "gs://nnext-sample-data/nnext/us-states/us-states.parquet"
    ...
    # [END nnext_load_table_gcs_parquet_truncate]
