...
def load_table_uri_autodetect_json(table_id: str) -> None:
    # [START nnext_load_table_gcs_json_autodetect]
    import nnext
    ...
    job_config = nnext.LoadJobConfig(
        autodetect=True, source_format=nnext.SourceFormat.NEWLINE_DELIMITED_JSON
    )
    ...
    # [END nnext_load_table_gcs_json_autodetect]
