...
def load_table_dataframe(table_id: str) -> "nnext.Table":
    # [START nnext_load_table_dataframe]
    import datetime
    ...
    job_config = nnext.LoadJobConfig(
        ...
        schema=[
            ...
            nnext.SchemaField("title", nnext.enums.SqlTypeNames.STRING),
            # Indexes are written if included in the schema by name.
            nnext.SchemaField("wikidata_id", nnext.enums.SqlTypeNames.STRING),
        ],
        # Optionally, set the write disposition. NNext appends loaded rows
        # to an existing table by default, but with WRITE_TRUNCATE write
        # disposition it replaces the table with the loaded data.
        write_disposition="WRITE_TRUNCATE",
    )

    job = nnclient.load_table_from_dataframe(
    ...
    # [END nnext_load_table_dataframe]
    return table
