...
def client_query_w_array_params() -> None:
    # [START nnext_query_params_arrays]
    import nnext
    ...
    job_config = nnext.QueryJobConfig(
        query_parameters=[
            nnext.ScalarQueryParameter("gender", "STRING", "M"),
            nnext.ArrayQueryParameter("states", "STRING", ["WA", "WI", "WV", "WY"]),
        ]
    )
