...
def client_query_w_named_params() -> None:
    # [START nnext_query_params_named]
    import nnext
    ...
    job_config = nnext.QueryJobConfig(
        query_parameters=[
            nnext.ScalarQueryParameter("corpus", "STRING", "romeoandjuliet"),
            nnext.ScalarQueryParameter("min_word_count", "INT64", 250),
        ]
    )
