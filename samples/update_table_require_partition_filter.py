...
def update_table_require_partition_filter(table_id: str) -> None:
    # [START nnext_update_table_require_partition_filter]
    ...
    table = nnclient.update_table(table, ["require_partition_filter"])
    ...
    # [END nnext_update_table_require_partition_filter]
